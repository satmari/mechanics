		...
		<div class="text-center col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading" >Add machine information:
						...
						@if (isset($msgs))
							<div class="panel-heading" >
								<p><span style="color:green;">{{ $msgs }}</span></p>
					       	</div>
						@endif
						@if (isset($msgbin))
							<div class="panel-heading" >
				...
				{!! Form::open(['url' => 'add_comment_ws_scan']) !!}
				...
				<!-- {!! Form::open(['url' => 'search_by_location_scan2']) !!} -->
					...
					<!-- <div class="panel-body">
                        ...
                        <select name="machine2" class="select form-control select-form">
                            <option value="" selected></option>
                            
                            @foreach ($machines as $m)
                            <option value="{{ $m->os }}">
                                <span >{{ $m->os }} / {{ $m->brand }} / {{ $m->type }} / {{ $m->code }}</span>
                            </option>
                            @endforeach
                        </select>
						<br>
				...
				<!-- <br> -->
				<hr>
	            <a href="{{ url('/afterlogin_ws') }}" class="btn btn-default btn-lg center-bl ock">Back</a>
	            <br>
	            <br>
