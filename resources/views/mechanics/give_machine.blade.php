	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-6 col-md-offset-3">
			<div class="panel panel-default">
				<div class="panel-heading" >Give Machine to (external plant)
	           ...
	           @if (isset($external_locations))
					@foreach ($external_locations as $d)
						...
						{!! Form::open(['method'=>'POST', 'url'=>'give_machine_to']) !!}
						{!! Form::hidden('give_machine_to', $d->location, ['class' => 'losbut form-control']) !!}
